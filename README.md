...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyvis-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8690&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyvis-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyvis` can be installed with:

```
conda install pyvis
```

It is possible to list all of the versions of `pyvis` available on your platform with:
